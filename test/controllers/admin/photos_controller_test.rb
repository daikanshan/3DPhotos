...
class Admin::PhotosControllerTest < ActionController::TestCase
  ...
  test "should create admin_photo" do
    assert_difference('Admin::Photo.count') do
      post :create, admin_photo: { album_id: @admin_photo.album_id, img: @admin_photo.img, name: @admin_photo.name, user_id: @admin_photo.user_id }
    end
  ...
  test "should update admin_photo" do
    patch :update, id: @admin_photo, admin_photo: { album_id: @admin_photo.album_id, img: @admin_photo.img, name: @admin_photo.name, user_id: @admin_photo.user_id }
    assert_redirected_to admin_photo_path(assigns(:admin_photo))
  end
